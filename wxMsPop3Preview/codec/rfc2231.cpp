...
bool wxRfc2231::ExtractParameter(const std::list<mimetic::FieldParam>& parameters_list, 
  const wxString& name, wxString& value)
{
...
wxString wxRfc2231::Decode(const std::list<mimetic::FieldParam>& parameters_list, 
  const wxString& parameter_name)
{
